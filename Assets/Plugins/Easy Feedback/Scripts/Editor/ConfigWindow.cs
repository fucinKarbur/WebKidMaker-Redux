...
namespace EasyFeedback.Editor
{
    public class ConfigWindow : EditorWindow
    {
        ...
        public static string GetAssetRootPath()
        {
            ...
            if (assetRootPath == null)
            {
                ...
                string[] guids = AssetDatabase.FindAssets(
                    "\"" + EditorConstants.ASSET_ROOT_DIRECTORY + "\"");
        ...
        /// and displays it.
        /// </summary>
        [MenuItem(EditorConstants.CONFIG_MENU_PATH)]
        ...
        private void loadConfigAsset()
        {
            config = AssetDatabase.LoadAssetAtPath<EFConfig>(
                GetAssetRootPath() + EditorConstants.CONFIG_ASSET_NAME);
        ...
        public void createConfigAsset()
        {
            ...
            AssetDatabase.CreateAsset(
                config, GetAssetRootPath() + EditorConstants.CONFIG_ASSET_NAME);
            EditorUtility.SetDirty(config);
            AssetDatabase.SaveAssets();
        ...
        private void boardControls()
        {
            ...
            {
                string[] boardNames = boards
                    .Select((b) => b.name.Replace("/", Constants.UNICODE_FORWARD_SLASH))
                    .ToArray();
